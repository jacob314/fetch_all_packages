...
class Marquee extends StatefulWidget {
  Marquee({
    ...
    Curve decelerationCurve = Curves.decelerate,
          ...
          "You need to either provide a text or multiple texts to be "
          "displayed. If you don't want to display something, consider "
          "passing an empty string as text instead."
        ),
        assert(text == null || texts == null,
          "You cannot provide both a text and multiple texts. If you want "
          "to display the text in front of the other texts, consider adding "
          "it to the front of the list."
        ),
        this.texts = texts ?? [ text ],
...
class _MarqueeState extends State<Marquee> with SingleTickerProviderStateMixin {
  ...
  void _initialize() {
    ...
    final totalLength = _getTotalWidth();
  ...
  double _getTotalWidth() {
    ...
    for (final String text in widget.texts) {
      ...
      width += tp.width + widget.blankSpace;
    }
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (_, i) {
        return i.isEven
          ? Text(widget.texts[(i ~/ 2) % widget.texts.length],
            style: widget.style
          )
          : _buildBlankSpace();
      }
