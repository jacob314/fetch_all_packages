...
import 'package:controller_chewie/src/chewie_progress_colors.dart';
import 'package:controller_chewie/src/cupertino_progress_bar.dart';
import 'package:controller_chewie/src/utils.dart';
...
class _CupertinoControlsState extends State<CupertinoControls> {
  ...
  Widget _buildBackButton(context, barHeight) {
        ...
        child: Row(
          ...
          children: <Widget>[
            IconButton(
                ...
                onPressed: () {
                  chewieController.onBack(context);
                }),
          ],
        ),
      ),
  ...
  Widget _buildTopBar(
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          _buildBackButton(context, barHeight),
