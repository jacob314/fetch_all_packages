...
class Chewie extends StatefulWidget {
  ...
  final Function(ControlEvent) onUserControlChanged;

  Chewie(this.controller,
      {Key key,
      this.aspectRatio,
...
class _ChewiePlayerState extends State<Chewie> {
  ...
  Widget build(BuildContext context) {
    return new PlayerWithControls(
        ...
        onUserControlChanged: widget.onUserControlChanged);
  }
...
//    }
    FlutterYoutubeExtractor.requestRotateScreen(isLandscape: true);
    ...
    FlutterYoutubeExtractor.requestRotateScreen(isLandscape: false);
  }
