...
/** MsgNotificationsPlugin */
public class MsgNotificationsPlugin implements EventChannel.StreamHandler {
  ...
  public static void registerWith(Registrar registrar) {
    ...
    MsgNotificationsPlugin plugin = new MsgNotificationsPlugin(context);
   ...
   */
  private MsgNotificationsPlugin(Context context) {
  ...
  private boolean permissionGiven() {
    ...
    Log.i("permissionGiven::p", packageName);
    Log.i("permissionGiven::flat", flat);
  ...
  class NotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      String msg = packageName + ":;:" + title+ ":;:" + ticker+ ":;:" + message;
      Log.i("notification received", msg);
