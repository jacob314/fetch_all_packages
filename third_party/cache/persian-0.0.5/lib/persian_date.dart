...
class PersianDate {
  ...
  String toString() {
    return toPersian(
        '$year/${month.toString().padLeft(2, '0')}/${day.toString().padLeft(2, '0')} ${_dateTime.hour.toString().padLeft(2, '0')}:${_dateTime.minute.toString().padLeft(2, '0')}:${_dateTime.second.toString().padLeft(2, '0')}');
  }

  PersianDate.fromGergorian(int gregYear, int gregMonth, int gregDay) {}
