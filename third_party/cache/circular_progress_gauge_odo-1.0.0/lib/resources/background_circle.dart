        ...
        ClipRRect(
          ...
          child: Stack(
            ...
            children: <Widget>[
              CustomContainer1(
                size: size,
                rangeColor: minRangeColor,
              ),
              CustomContainer2(
                size: size,
                rangeColor: maxRangeColor,
              ),
              CustomContainer3(
                size: size,
                rangeColor: midRangeColor,
              ),
              CustomContainer4(
                size: size,
                rangeColor: bottomCircleColor,
              ),
              CustomContainer5(
                size: size,
                rangeColor: innerCircleColor,
              ),
              CustomContainer6(
                size: size,
                rangeColor: displayBackgroundColor,
