...
class AfterRoutingHandler {
  ...
  Map<void Function(dynamic), dynamic> _callbackFuncDataMap = {};
  ...
  scheduleFuture<DataType>(
    ...
    if (runImmediately) {
      future
          .then((data) => _whenFutureFinished<DataType>(successDelegate, data))
          .catchError((e) => _whenFutureFinished<Error>(errorCallback, e));
    } else {
  ...
  _whenFutureFinished<DataType>(void Function(DataType) callback, DataType data) {
