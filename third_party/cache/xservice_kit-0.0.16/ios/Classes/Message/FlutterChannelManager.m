...
{
#if DEBUG
    NSArray *methodChannels = @[@"testor"];
    NSArray *eventChannels = @[@"event_testor"];
    return @{@"method_channel":methodChannels,
             @"event_channel":eventChannels};
#else
    //TODO:
    return @{};
#endif
...
- (BOOL)isConfigValid:(NSDictionary *)config
{
    //TODO:
    return YES;
}
...
- (void)reloadChannels:(NSDictionary *)config
{
...
//    
//    if (config) {
//        NSArray *methodChannels = config[@"method_channel"];
//        NSArray *eventChannels = config[@"event_channel"];
//        
//        for(NSString *name in methodChannels){
//            [self registerMethodChannel:name];
//        }
//        
//        for(NSString *name in eventChannels){
//            [self registerEventChannel:name];
//        }
//    }else{
//        MCLog(@"nil config cannot init channel manager!");
//    }
}
...
{
    //TODO: Send channel sync cmd throung root channel.
}
