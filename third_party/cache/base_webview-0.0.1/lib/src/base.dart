...
class FlutterWebviewPlugin {
  ...
  final _onUrlOverridden = new StreamController<String>.broadcast();
  final _onSchemeMatched = new StreamController<String>.broadcast();
  ...
  Future<Null> _handleMessages(MethodCall call) async {
    switch (call.method) {
      ...
      case 'onHttpError':
        ...
        break;
      case 'onUrlOverridden':
        _onUrlOverridden.add(call.arguments['url']);
        break;
      case 'onSchemeMatched':
        _onSchemeMatched.add(call.arguments['url']);
        break;
    }
  }
  ...
  Stream<String> get onUrlOverridden => _onUrlOverridden.stream;

  Stream<String> get onSchemeMatched => _onSchemeMatched.stream;
  ...
  Future<Null> launch(String url,
      ...
      bool scrollBar,
      String html,
      bool withWideViewPort,
      bool autoLoadImage,
      BigInt cacheMaxSize,
      bool allowFileAccess,
      bool appCacheEnabled,
      String defaultTextEncodingName}) async {
    final args = <String, dynamic>{
      ...
      'html': html,
      'withWideViewPort': withWideViewPort ?? true,
      'autoLoadImage': autoLoadImage ?? true,
      'cacheMaxSize': cacheMaxSize,
      'allowFileAccess': allowFileAccess ?? true,
  ...
  void dispose() {
    ...
    _onHttpError.close();
    _onUrlOverridden.close();
    _onSchemeMatched.close();
    _instance = null;
  }
  ...
  Future setOverridableUrls(List<String> overridableUrls) => _channel
      .invokeMethod('setOverridableUrls', {'overridableUrls': overridableUrls});

  Future setUriSchemes(List<String> schemes) =>
      _channel.invokeMethod('setUriSchemes', {'schemes': schemes});
}
