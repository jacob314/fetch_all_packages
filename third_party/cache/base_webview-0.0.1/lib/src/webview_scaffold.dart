...
class WebviewScaffold extends StatefulWidget {
  ...
  final Function(String) onSchemeMatched;
  final List<String> targetSchemes;
...
class _WebviewScaffoldState extends State<WebviewScaffold> {
  ...
  void initState() {
    ...
    webviewReference.setUriSchemes(widget.targetSchemes);

    webviewReference.onSchemeMatched.listen((String url) {
      widget.onSchemeMatched(url);
    });
