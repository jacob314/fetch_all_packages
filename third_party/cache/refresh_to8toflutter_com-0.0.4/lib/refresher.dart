...
class PullAndLoadMoreWidget extends StatefulWidget {
  // 加载刷新回调
...
class EasyRefreshState extends State<PullAndLoadMoreWidget>
    with TickerProviderStateMixin<PullAndLoadMoreWidget> {
  // 滚动控制器
    ...
    if (_bottomItemHeight > 0.0 &&
      ...
      setState(() {
        _scrollPhysics = RefreshScrollPhysics(
            _refreshHeader.isFloat, _refreshFooter.isFloat);
      });
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.child is ScrollView) {
      ...
      if (widget.emptyWidget != null &&
          (widget.child as ScrollView).semanticChildCount == 0) {
