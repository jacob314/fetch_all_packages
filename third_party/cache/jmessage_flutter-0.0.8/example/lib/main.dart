...
class _MyAppState extends State<MyApp> {
  ...
  void testSingleApi() async {
    ...
    JMGroupInfo group = await jmessage.getGroupInfo(id: gid);
    print("group info: ${group.toJson()}");
  }
      ...
      if (msg is JMTextMessage) {
        ...
        jmessage.createMessage(
          ...
          jmessage.sendMessage(
            ...
            print('send voice message success ${res.toJson()}');
          });
        });
      }
