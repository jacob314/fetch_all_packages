package net.sataspes.fluttercontactsplugin;
...
public class FlutterContactsPlugin implements MethodCallHandler {
  /** Plugin registration. */
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "flutter_contacts_plugin");
    channel.setMethodCallHandler(new FlutterContactsPlugin(registrar.context().getContentResolver()));
  }
  FlutterContactsPlugin(ContentResolver contentResolver){
