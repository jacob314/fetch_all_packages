...
class Button3dStyle {
  final Color topColor; // color of the button face
  final Color backColor; // color of button body
  final BorderRadius borderRadius;
  final double z; // z-dimension
  final double tappedZ; // z-dimension when button tapped
