...
class BluetoothDevice {
  ...
  Future<List<BluetoothService>> discoverServices() async {
    await FlutterBluetoothClassic.instance._channel
        .invokeMethod('discoverServices', id.toString());

    return await FlutterBluetoothClassic.instance._servicesDiscoveredChannel
  ...
  Future<List<BluetoothService>> get services {
    return FlutterBluetoothClassic.instance._channel
  ...
  Future<List<int>> readCharacteristic(
    ...
    return await FlutterBluetoothClassic.instance._characteristicReadChannel
        .receiveBroadcastStream()
        .map((buffer) =>
  ...
  Future<List<int>> readDescriptor(BluetoothDescriptor descriptor) async {
    ...
    return await FlutterBluetoothClassic.instance._descriptorReadChannel
        .receiveBroadcastStream()
        .map((buffer) =>
  ...
  Future<Null> writeCharacteristic(BluetoothCharacteristic characteristic, List<int> value,
    ...
    var result = await FlutterBluetoothClassic.instance._channel
    ...
    return await FlutterBluetoothClassic.instance._methodStream
  ...
  Future<bool> setNotifyValue(
    ...
    await FlutterBluetoothClassic.instance._channel.invokeMethod('setNotification', request.writeToBuffer());
  ...
  Stream<List<int>> onValueChanged(BluetoothCharacteristic characteristic) {
    return FlutterBluetoothClassic.instance._methodStream
  ...
  Future<BluetoothDeviceState> get state =>
      FlutterBluetoothClassic.instance._channel.invokeMethod('deviceState', id.toString())
