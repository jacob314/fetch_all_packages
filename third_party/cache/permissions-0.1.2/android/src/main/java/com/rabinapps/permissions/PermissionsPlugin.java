package com.rabinapps.permissions;
...
/** PermissionsPlugin */
public class PermissionsPlugin implements MethodCallHandler, PluginRegistry.RequestPermissionsResultListener {
  private Registrar registrar;
  private Result result;
  /** Plugin registration. */
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "permissions");
    PermissionsPlugin permissionsPlugin = new PermissionsPlugin(registrar);
    channel.setMethodCallHandler(permissionsPlugin);
    registrar.addRequestPermissionsResultListener(permissionsPlugin);
    }

    private PermissionsPlugin(Registrar registrar) {
    ...
    private boolean checkPermission(String permission) {
        Activity activity = registrar.activity();
        permission = getManifestPermission(permission);
        Log.i("Permission", "Checking permission : " + permission);
    ...
    public boolean onRequestPermissionsResult(int requestCode, String[] strings, int[] grantResults) {
        ...
        if (requestCode == 0 && grantResults.length > 0) {
            ...
            Log.i("Permission", "Requesting permission result : " + res);
            result.success(res);
        }
        return res;
    }
