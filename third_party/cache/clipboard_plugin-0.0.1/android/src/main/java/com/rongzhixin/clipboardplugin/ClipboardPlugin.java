package com.rongzhixin.clipboardplugin;
...
public class ClipboardPlugin implements MethodCallHandler {
  ...
  public ClipboardPlugin(Registrar registrar) {
    this.registrar = registrar;
  }

  /** Plugin registration. */
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "clipboard_plugin");
