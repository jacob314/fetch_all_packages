...
- [Android](https://github.com/awareframework/com.awareframework.android.sensor.health)
- [iOS](https://github.com/awareframework/com.awareframework.ios.sensor.health)

## Example usage
```dart
// init config
var config = HealthSensorConfig()
  ..debug = true
  ..label = "label";

// init sensor
var sensor = new HealthSensor(config);
...
void mathod(){
    ...
    var card = new HealthCard(sensor:sensor);
