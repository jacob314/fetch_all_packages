...
import 'package:flutter_mashov_api/src/utils.dart';
...
class ApiController {
  ...
  ///Creates a new Api Contrller from injection.
  ApiController() {
    jsonHeader = new Map<String, String>();
    jsonHeader["Content-Type"] = "application/json;charset=UTF-8";
    Injector injector = Injector.getInjector();
    _cookieManager = injector.get(key: "CookieManager");
    _requestController = injector.get(key: "RequestController");
  }

  ///Cookie Manager and Request Controller are inside the constructor,
  ///in order to enable easier testing and mocking.
  ApiController.fromMock(CookieManager manager, RequestController controller) {
    setJsonHeader();
